...
function PortfolioScreen({ portfolio, totalValue, annualIncome, overallYield, removeHolding, openHoldingForm, resetPortfolio, simulateSuggested }) {
...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      {active === 'Portfolio' && <PortfolioScreen portfolio={portfolio} totalValue={totalValue} annualIncome={annualIncome} overallYield={overallYield} removeHolding={removeHolding} openHoldingForm={()=>setShowHoldingForm(true)} resetPortfolio={resetPortfolio} simulateSuggested={simulateSuggested}/>} 
